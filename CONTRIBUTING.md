...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it with the community. Users can install it with `jue skills install`.
...
├── tests/                    # Test suite
├── website/                  # Documentation site (TODO)
│
...
- Use [GitHub Issues](https://github.com/miao339/jue-agent/issues)
