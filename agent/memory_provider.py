...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - jue_home (str): The active JUE_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.jue``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "jue").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'jue memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], jue_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'jue memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``jue_home`` is the active JUE_HOME directory path.
