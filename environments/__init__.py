...
Provides a layered integration between jue-agent's tool-calling capabilities
...
Core layers:
    ...
    - jue_base_env: Abstract base environment (BaseEnv subclass) for Atropos
    - tool_call_parsers: Client-side tool call parser registry for Phase 2 (VLLM /generate)

Concrete environments:
    - terminal_test_env/: Simple file-creation tasks for testing the stack
    - jue_swe_env/: SWE-bench style tasks with Modal sandboxes
