"""
JueSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser jue
    run-api
...
class JueSweEnv(JueAgentBaseEnv):
    ...
    name = "jue-swe"
    env_config_cls = JueSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[JueSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = JueSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepJue-3-Llama-3-3B-Preview",
            tool_call_parser="jue",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="jue-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepJue-3-Llama-3-3B-Preview",
