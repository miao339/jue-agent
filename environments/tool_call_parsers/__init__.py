...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("jue")
        class JueToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "jue", "mistral", "llama3_json")
...
from environments.tool_call_parsers.jue_parser import JueToolCallParser  # noqa: E402, F401
