...
Inspired by: GroceryMind — production Jue agent doing live web research
             across German grocery stores (firecrawl + jue-agent)
"""
...
# Ensure jue-agent root is on path
...
class WebResearchEnvConfig(JueAgentEnvConfig):
...
class WebResearchEnv(JueAgentBaseEnv):
    """
