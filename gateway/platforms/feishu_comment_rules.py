...
Config: ~/.jue/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.jue/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_jue_home()`` helper (JUE_HOME-aware and
...
RULES_FILE = get_jue_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_jue_home() / "feishu_comment_pairing.json"
