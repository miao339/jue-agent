...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_jue_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/jue")
            async def handle_jue_command(ack, command):
                await ack()
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own Jue session — matching the per-thread behavior channels already
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "jue_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "jue_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "jue_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "jue_approve_once": "once",
            "jue_approve_session": "session",
            "jue_approve_always": "always",
            "jue_deny": "deny",
        }
