...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'jue cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: jue gateway install", Colors.DIM))
        print(color("                    sudo jue gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    jue gateway install    # Install as a user service")
        print("    sudo jue gateway install --system  # Linux servers: boot-time system service")
        print("    jue gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: jue cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
