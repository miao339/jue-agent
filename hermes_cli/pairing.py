...
Usage:
    jue pairing list              # Show all pending + approved users
    jue pairing approve <platform> <code>  # Approve a pairing code
    jue pairing revoke <platform> <user_id> # Revoke user access
    jue pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle jue pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: jue pairing {list|approve|revoke|clear-pending}")
        print("Run 'jue pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'jue pairing list' to see pending codes.\n")
