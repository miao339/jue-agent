#!/usr/bin/env python3
"""
SWE Runner with Jue Trajectory Format

A runner that uses Jue-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Jue-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Jue-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Jue format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Jue-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Jue-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Jue Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Jue-Agent's built-in execution environments
    and outputs trajectories in Jue-Agent format.
    """
    ...
    def _convert_to_jue_format(
        ...
        """
        Convert internal message format to Jue trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Jue trajectory format
        trajectory = self._convert_to_jue_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Jue trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Jue Trajectory Format")
    print("=" * 60)
