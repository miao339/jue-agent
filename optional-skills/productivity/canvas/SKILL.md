...
4. Name the token (e.g., "Jue Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.jue/.env`:
...
```bash
CANVAS="python $JUE_HOME/skills/productivity/canvas/scripts/canvas_api.py"
