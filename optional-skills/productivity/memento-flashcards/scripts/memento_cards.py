...
Data file: $JUE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_JUE_HOME = Path(os.environ.get("JUE_HOME", Path.home() / ".jue"))
DATA_DIR = _JUE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
