#!/usr/bin/env python3
"""Build the Jue Skills Index — a centralized JSON catalog of all skills.
...
`jue skills search/install` can use it without hitting the GitHub API.
...
# Ensure JUE_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("JUE_HOME", os.path.join(os.path.expanduser("~"), ".jue"))
...
def main():
    print("Building Jue Skills Index...", flush=True)
