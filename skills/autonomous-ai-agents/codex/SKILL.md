...
metadata:
  jue:
    ...
    related_skills: [claude-code, jue-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Jue terminal. Codex is OpenAI's autonomous coding agent CLI.
