...
Built for [Hermes Agent](https://github.com/miao339/jue-agent). Usable in any coding agent. Canonical source lives here; synced to [`miao339/jue-agent/skills/creative/ascii-video`](https://github.com/miao339/jue-agent/tree/main/skills/creative/ascii-video) via PR.
