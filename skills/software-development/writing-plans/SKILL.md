...
version: 1.1.0
author: Jue Agent (adapted from obra/superpowers)
license: MIT
metadata:
  jue:
...
> **For Jue:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Jue tools to understand the project:
