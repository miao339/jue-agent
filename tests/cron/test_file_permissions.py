...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("hermes_cli.config.get_config_path", return_value=config_path), \
             patch("hermes_cli.config.ensure_jue_home"):
    ...
    def test_ensure_jue_home_sets_0700(self):
        home = Path(self.tmpdir) / ".jue"
        with patch("hermes_cli.config.get_jue_home", return_value=home):
