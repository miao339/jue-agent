...
class TestDoctorMemoryProviderSection:
    ...
    def _make_jue_home(self, tmp_path, provider=""):
        """Create a minimal JUE_HOME with config.yaml."""
        home = tmp_path / ".jue"
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_jue_home(tmp_path, provider)
