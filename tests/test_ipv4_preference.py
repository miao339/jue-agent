...
def _reload_constants():
    """Reload jue_constants to get a fresh apply_ipv4_preference."""
    import jue_constants
    importlib.reload(jue_constants)
    return jue_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_jue_ipv4_patched", False) is True
