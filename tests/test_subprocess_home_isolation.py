...
See: https://github.com/NousResearch/jue-agent/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for jue_constants.get_subprocess_home()."""

    def test_returns_none_when_jue_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("JUE_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("JUE_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(jue_home / "home")
    ...
    def test_no_injection_when_jue_home_unset(self, monkeypatch):
        monkeypatch.delenv("JUE_HOME", raising=False)
