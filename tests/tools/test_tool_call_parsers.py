...
class TestParserRegistry:
    ...
    def test_jue_parser_registered(self):
        parsers = list_parsers()
        assert "jue" in parsers
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["jue"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use jue format since that's universal
