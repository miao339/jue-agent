...
def clean_env(monkeypatch):
    ...
    monkeypatch.delenv("JUE_LOCAL_STT_COMMAND", raising=False)
    monkeypatch.delenv("JUE_LOCAL_STT_LANGUAGE", raising=False)
...
class TestTranscribeLocalCommand:
    ...
    def test_command_fallback_with_template(self, monkeypatch, sample_ogg, tmp_path):
        ...
        monkeypatch.setenv("JUE_LOCAL_STT_LANGUAGE", "en")
