...
Trust levels:
  - builtin:   Ships with Jue. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.jue/\.env|\~/\.jue/\.env',
     "jue_env_access", "critical", "exfiltration",
     "directly references Jue secrets file"),
    ...
    (r'\.jue/config\.yaml|\.jue/SOUL\.md',
     "jue_config_mod", "critical", "persistence",
     "references Jue configuration files directly"),
