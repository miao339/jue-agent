...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/jue-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/jue-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/jue-results"
HEREDOC_MARKER = "JUE_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"JUE_PERSIST_{uuid.uuid4().hex[:8]}"
