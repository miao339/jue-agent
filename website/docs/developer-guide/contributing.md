...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Jue Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Jue Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- **Profile-safe paths**: Never hardcode `~/.jue` — use `get_jue_home()` from `jue_constants` for code paths and `display_jue_home()` for user-facing messages. See [AGENTS.md](https://github.com/miao339/jue-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.

## Cross-Platform Compatibility

Jue officially supports Linux, macOS, and WSL2. Native Windows is **not supported**, but the codebase includes some defensive coding patterns to avoid hard crashes in edge cases. Key rules:
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/miao339/jue-agent/blob/main/LICENSE).
