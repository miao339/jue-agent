...
- **Profile-safe paths**: Never hardcode `~/.jue` — use `get_jue_home()` from `jue_constants` for code paths and `display_jue_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/hermes-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
