...
Connect Jue to WeCom (Enterprise WeChat) as a self-built enterprise application using the callback/webhook model.

:::info WeCom Bot vs WeCom Callback
Jue supports two WeCom integration modes:
...
3. Jue decrypts the message, queues it for the agent
